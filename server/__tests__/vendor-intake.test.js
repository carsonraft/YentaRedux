...
describe('Vendor Intake API', () => {
  ...
  describe('POST /api/vendors/intake', () => {
    const mockVendorData = {
      ...
      industry: 'technology',
      expertise: ['machine_learning', 'computer_vision', 'nlp'],
      mdfBudget: 50000,
    ...
    it('should validate MDF budget', async () => {
      ...
      expect(response.body.error).toBe('MDF budget must be positive');
    });
    ...
    it('should handle targeting preferences validation', async () => {
      ...
      expect(response.body.error).toBe('Invalid targeting preferences');
    });
    ...
    it('should sanitize and normalize data', async () => {
      ...
      expect(response.body.vendor.industry).toBe('technology');
    });
  });
  ...
  describe('PUT /api/vendors/:id/targeting', () => {
    ...
    it('should update vendor targeting preferences', async () => {
      ...
      expect(response.body.success).toBe(true);
      expect(response.body.targetingPreferences).toMatchObject(updatedTargeting);
    });
      ...
      const mockVendors = [
        {
          ...
          industry: 'technology',
          expertise: ['machine_learning', 'healthcare_ai'],
          mdf_budget: 75000
        },
        {
          id: 2,
          ...
          industry: 'technology', 
          expertise: ['machine_learning', 'financial_ai'],
          mdf_budget: 100000
        }
      ];
